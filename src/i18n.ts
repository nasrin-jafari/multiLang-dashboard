  ...
  resources: {
    en: {
      translation: {
        ...
        redirectToSettings: "Go to settings",
        changeUserName: "Please register your username.",
        yesQuestion: "Yes",
        noQuestion: "No",
    ...
    fa: {
      translation: {
        ...
        Guest: "مهمان",
        registerUserName: "ثبت نام کاربری",
        redirectToSettings: "برو به تنظیمات",
        changeUserName: "لطفا نام کاربری خود را ثبت کنید .",
        yesQuestion: "بله",
        noQuestion: "خیر",
        deleteTodo: "حذف تسک",
        confirmDelete: "آیا از حذف آن مطمعن هستید؟",
      },
    },
  },
  lng: initialLanguage,
